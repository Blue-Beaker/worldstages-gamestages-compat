...
public class GameStageHelper {
    private static boolean hasWorldStage (EntityPlayer player, String stage){
        return WorldStagesWorldSavedData.get(player.world).stages.contains(stage);
    }
    /**
    ...
    public static boolean hasStage (EntityPlayer player, IStageData data, String stage) {
        ...
        if (data != null) {
            ...
            final GameStageEvent.Check event = new GameStageEvent.Check(player, stage, data.hasStage(stage)||hasWorldStage(player, stage));
